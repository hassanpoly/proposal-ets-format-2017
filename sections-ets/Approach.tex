...
\begin{tabular}{|c|c|c|c|} 
 \hline
 \rowcolor{lightgray}
Faulty Value(Stuck-at-fault) & Faulty Value (Variable change) & Signature (Stuck-at-fault) & Signature (Variable Change)   \\ 
\hline
...
CM = \bordermatrix{~& Sign-1 & Sign-2 & Sign-3 & Sign-4\cr
                  ...
                  $delay$  $fault$\rightarrow{C_1} & 0.25 & 0.25 &0.25 &0.25\cr
                  $Variable$  $Change$\rightarrow{O_0} & 0.05 & 0.10 &0.35 &0.50\cr}
\end{center}
\end{itemize}
